...
<div id="addiv" style="position: fixed; Z-INDEX: 9200; right: 0px; bottom: 0px;width: 300px;height: 250px">
...
<iframe  src="http://ad.adtina.com/ad/9/<%=request.getParameter("adId") %>" width="300px" height="250px" border="0"   marginwidth="0" marginheight="0"  frameborder="0"
