...
public class AdStatRedisInfo {
	...
	public void setCurrentHour_mobile_click_num(
			String currentHour_mobile_click_num) {
	...
	public String toString() {
		...
		statInfo.append("currentHour_click_num="
				+ this.getCurrentHour_click_num() + ",");
		statInfo.append("currentHour_ip_num=" + this.getCurrentHour_ip_num()
				+ ",");
		statInfo.append("currentHour_mobile_click_num="
				+ this.getCurrentHour_mobile_click_num() + ",");
		statInfo.append("currentHour_mobile_pv_num="
				+ this.getCurrentHour_mobile_pv_num() + ",");
