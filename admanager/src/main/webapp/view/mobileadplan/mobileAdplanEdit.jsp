...
<form class="form-horizontal" method="post" action="/mobileadplan/adplaneditsaveaction/${mobileAdPlanManageInfo.adInstanceDto.adId }" id="adplanFrom">
<fieldset>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xlarge focused" id="adInstanceDto.adName"
                   name="adInstanceDto.adName" type="text"  value="${mobileAdPlanManageInfo.adInstanceDto.adName}"/>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <textarea class="autogrow" id="adInstanceDto.adDesc"
                      name="adInstanceDto.adDesc">${mobileAdPlanManageInfo.adInstanceDto.adDesc }</textarea>
        </div>
    </div>
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-small datepicker autogrow"
                   id="adInstanceDto.startTime" name="adInstanceDto.startTime" value="${mobileAdPlanManageInfo.adInstanceDto.startTime }"/>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="autogrow input-small datepicker"
                   id="adInstanceDto.endTime" name="adInstanceDto.endTime" value="${mobileAdPlanManageInfo.adInstanceDto.endTime }"/>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <select
                    ...
                    >
                 <option value="1" <c:if test="${mobileAdPlanManageInfo.adInstanceDto.chargeType=='1' }">selected</c:if>>按展示付费(CPM)</option>
                <option value="2" <c:if test="${mobileAdPlanManageInfo.adInstanceDto.chargeType=='2' }">selected</c:if>>按点击付费(CPC)</option>
            </select>
        </div>
    </div>
    ...
    <label class="control-label" for="focusedInput"><b style="color: #FF0000;">*</b>计划曝光数</label>
        <div class="controls">
            <input class="input-small focused" id="adInstanceDto.total"
                   name="adInstanceDto.total" type="text" value="${mobileAdPlanManageInfo.adInstanceDto.total}" />
        ...
        <div class="controls">
            ...
            <div class="input-prepend input-append">
                <span class="add-on">￥</span><input
                    id="adInstanceDto.allBudget" name="adInstanceDto.allBudget" size="8" type="text" value="${mobileAdPlanManageInfo.adInstanceDto.allBudget }" />
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <div class="input-prepend input-append">
                <span class="add-on">￥</span><input
                    id="adInstanceDto.dayBudget" name="adInstanceDto.dayBudget" size="8" type="text" value="${mobileAdPlanManageInfo.adInstanceDto.dayBudget }"/>
                <!-- <span class="add-on">.00</span> -->
    ...
    <!-- 渠道选择 不需要设置直接是 3 -->
           ...
           <label class="control-label"><b style="color: #FF0000;">*</b>该广告投放渠道:
           <c:if test="${mobileAdPlanManageInfo.adInstanceDto.channel == '1'}">
		         	TANX
		        </c:if>
		        <c:if test="${mobileAdPlanManageInfo.adInstanceDto.channel == '3'}">
		         	芒果
	        	</c:if>
           </label>
        
        <input  id="adInstanceDtoChannel" name="adInstanceDto.channel"  value="${mobileAdPlanManageInfo.adInstanceDto.channel}"  type="hidden" />
    </div>
      <div class="control-group" id="max_cpm_bidpriceDiv" >
        <label class="control-label">最高出价(分/cpm)：</label>
        <div class="controls">
            <div class="input-prepend input-append">
                <input  id="max_cpm_bidprice" name="adInstanceDto.maxCpmBidprice"  value="${mobileAdPlanManageInfo.adInstanceDto.maxCpmBidprice }"  type="text" />
...
<legend> 时间定向 </legend>
    ...
    <input type="hidden" id="putHours" name="putHours" value='${mobileAdPlanManageInfo.putHours }'/>
...
<fieldset>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            每 <input class="input-xlarge focused"
                     ...
                     type="text" value="${mobileAdPlanManageInfo.adTimeFrequencyDto.putIntervalNum }" style="width: 30px" /> <select
                id="adTimeFrequencyDto.putIntervalUnit" name="adTimeFrequencyDto.putIntervalUnit"
                style="width: 80px">
            <option value="W"
            <c:if test="${mobileAdPlanManageInfo.adTimeFrequencyDto.putIntervalUnit=='W' }">selected</c:if>>周</option>
            <option value="D"
            <c:if test="${mobileAdPlanManageInfo.adTimeFrequencyDto.putIntervalUnit=='D' }">selected</c:if>>天</option>
            <option value="H"
            <c:if test="${mobileAdPlanManageInfo.adTimeFrequencyDto.putIntervalUnit=='H' }">selected</c:if>>小时</option>
            <option value="M"
            <c:if test="${mobileAdPlanManageInfo.adTimeFrequencyDto.putIntervalUnit=='M' }">selected</c:if>>分钟</option>
            <option value="S"
            <c:if test="${mobileAdPlanManageInfo.adTimeFrequencyDto.putIntervalUnit=='S' }">selected</c:if>>秒</option>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <input class="input-xlarge focused" id="adTimeFrequencyDto.dayLimit"
                   name="adTimeFrequencyDto.dayLimit"" type="text" value="${mobileAdPlanManageInfo.adTimeFrequencyDto.dayLimit }"
            style="width: 50px" />
    ...
    <div class="control-group">
        ...
        <div class="controls">
			<!--  
            每 <select id="adUserFrequencyDto.timeUnit" name="adUserFrequencyDto.timeUnit"
                      style="width: 80px">
            <option value="W"
            <c:if test="${mobileAdPlanManageInfo.adUserFrequencyDto.timeUnit =='W' }">selected</c:if>>周</option>
            <option value="D"
            <c:if test="${mobileAdPlanManageInfo.adUserFrequencyDto.timeUnit =='D' }">selected</c:if>>天</option>
            <option value="H"
            <c:if test="${mobileAdPlanManageInfo.adUserFrequencyDto.timeUnit =='H' }">selected</c:if>>小时</option>
            <option value="M"
            <c:if test="${mobileAdPlanManageInfo.adUserFrequencyDto.timeUnit =='M' }">selected</c:if>>分钟</option>
            <option value="S"
            <c:if test="${mobileAdPlanManageInfo.adUserFrequencyDto.timeUnit =='S' }">selected</c:if>>秒</option>
        </select> 
        -->
        ...
        每天最多展现 <input class="input-xlarge focused"
                              ...
                              type="text" value="${mobileAdPlanManageInfo.adUserFrequencyDto.uidImpressNum }" style="width: 30px" /> 次
...
<br/>
   ...
   <input type="hidden" name="adIndustryIds" id="adIndustryIds" value="${mobileAdPlanManageInfo.adIndustryIds}"/>
        ...
        <div class="row-fluid sortable">
                <c:if test="${not empty adTypes}">
                        <c:forEach var="adType" items="${adTypes}">
                            <input name="adType.id" type="radio" value="${adType.id}" <c:if test="${adType.id==mobileAdPlanManageInfo.adType.id}">checked=checked</c:if> />${adType.description}
                        </c:forEach>
                </c:if>
        </div>
    </div>
...
<br/>
        ...
        <input type="hidden" name="adAppIds" id="adAppIds" value="${mobileAdPlanManageInfo.adAppIds}"/>
<fieldset>
                    ...
                    <tr>
                        <td>
                            <select id="app_f"  multiple="multiple"  style="height:200px;" ondblclick="moveOption(true, 'app_f', 'app_t', 'adAppIds')">
                                <c:if test="${not empty allAdApps}">
                                    <c:forEach var="adApp" items="${allAdApps}">
                        ...
                        <td style="text-align: center;">
                            <input type="button" value="添加" onclick="moveOption(true,'app_f', 'app_t' , 'adAppIds')"><br><br>
			                <input type="button" value="全选" onclick="moveAllOption(true,'app_f', 'app_t' , 'adAppIds')"><br><br>
			                <input type="button" value="删除" onclick="moveOption(false,'app_t', 'app_f' , 'adAppIds')"><br><br>
			                <input type="button" value="全删" onclick="moveAllOption(false,'app_t', 'app_f' , 'adAppIds')">
                        </td>
                        <td>
...
<fieldset>
    ...
    <input type="hidden"  id="param_adClickId" value="${mobileAdPlanManageInfo.adClick.id}" />
<!-- 渠道选择 -->
        <div class="control-group">
            <div class="input-prepend input-append">
                  <c:if test="${not empty adClicks}">
                        <c:forEach var="adClick" items="${adClicks}" varStatus="sts">
                            <input name="adClick.id" type="radio" onclick="setDeny(this)" value="${adClick.id}" id="adClickId${sts.index}"   <c:if test="${adClick.id==mobileAdPlanManageInfo.adClick.id}">checked=checked</c:if>/>${adClick.type}
                        </c:forEach>
                </c:if>
                <span id="dayBudgetTips" class="help-inline" style="display:none"></span>
        </div>
        ...
        <span class="add-on" id="adClickTargetSpan">输入邮件地址：</span>
            <input class="input-xlarge focused" id="adClick.target"
                   name="adClick.target" type="text" value="${mobileAdPlanManageInfo.adClick.target}" />
...
<fieldset>
    ...
    <input type="hidden"  id="param_adDeviceIds" value="${mobileAdPlanManageInfo.adDeviceIds}" />
        <div class="control-group">
...
<fieldset>
    ...
    <textarea style="resize: none; width: 60%; height: 180px;"
            ...
            >${mobileAdPlanManageInfo.adInstanceDto.ad3statCode}</textarea>
    <br />
    <br />
</fieldset>
...
<fieldset>
    ...
    <textarea style="resize: none; width: 60%; height: 180px;"
              id="adInstanceDto.ad3statCodeSub" name="adInstanceDto.ad3statCodeSub">${mobileAdPlanManageInfo.adInstanceDto.ad3statCodeSub}</textarea>
    <br />
    <br />
</fieldset>
...
//             	}
               ...
               } else if(adClick == 2 || adClick==3 || adClick == 6 || adClick==7) {
            	  
               } else if(adClick == 4 || adClick == 5) {
            ...
            if($(this).val()==4||$(this).val()==5) {
                ...
                $("#adClickTargetSpan").text("请输入地图地址：");
            } else {
                $("#adClickTargetSpan").text("请输入其它内容：");
            }
...
function  initClickTip() {
	var clickValue = $('input[name="adClick\\.id"]:checked').val();
	if(clickValue==4||clickValue==5) {
        $("#adClickTargetSpan").text("请输入手机号：");
...
function initDevices() {
	// 获取设备类型
	var deviceIds  = $("#param_adDeviceIds").val();
	if(deviceIds!=null && deviceIds != "") {
        var idarr = deviceIds.split(",");
        for(var i=0; i < idarr.length-1; i++) {
            //alert(idarr[i]);
        	$("[name = adDeviceIds][value$="+ idarr[i] +"]:checkbox").attr("checked", true);
            $("[name = adDeviceIds][value$="+ idarr[i] +"]:checkbox").parent().addClass("checked");
        }
    }
}
