				...
				<div class="box span12">
						<div class="row-fluid" >
								...
								<ul class="nav nav-tabs">
									<li class="active"><a href="#home" data-toggle="tab">广告报告--<strong>${adInstance.adName}</strong></a></li>
								    <!-- <li><a href="#urlShow" data-toggle="tab" onclick="urlClick()">网址报告</a></li> -->
								</ul>
								<div class="tab-content" style="overflow: visible;">
									<div class="tab-pane active" id="home">
										<jsp:include page="/ad/single-ad-report/${singleAdId}" flush="true" ></jsp:include>
									</div>
...
<div class="modal hide" id="adReportLook"  style="height:500px;width:800px;">
...
function urlClick(){
	...
	$("#urlReportFrame").attr("src","/ad/single-url-host/${singleAdId}");
}
</script>
