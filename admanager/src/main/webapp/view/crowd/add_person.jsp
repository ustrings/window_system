	...
	<div class="add_person">
		...
		<div class="box_content">
			...
			<div class="control_group" id="crowdNameDiv">
				...
				<div class="controls">
					<input class="input_xlarge" type="text"  name="crowdName" id="crowdName"/>
			...
			<div class="control_group" id="expressDateDiv">
				...
				<div class="controls">
					<input class="input_small input_datepicker" type="text"  name="expressDate" id="expressDate"/>
			...
			<div class="control_group" >
				...
				<div class="controls">
					<div class="input_prepend input_append">
							<div class="radio">
								<span>
									<input type="radio" size="8" value="0" name="direct_type" checked="true" />
								</span>
							</div>
				...
				<div class="controls_content" id="keyword" style="display:none;">
					<div class="control_group">
						...
						<div class="controls">
							<div class="input_prepend input_append">
								<div class="radio">
									<span>
										<input type="radio" size="8" value="1" name="isJisoujitou" checked="true" />
									</span>
								</div>
					...
					<div class="opera_DIV"  id="opera_DIV">
										...
										<tr>
											<td align="left">
												...
												<span style="position:absolute;border-top:1pt solid #c1c1c1;border-left:1pt solid #c1c1c1;border-bottom:1pt solid #c1c1c1;width:110px;height:24px;" >
													<input type="text" id="kwUrlFetchCicleInput" value="1天" style=" border: 0 none;height: 21px;line-height: 21px;margin: 0; padding: 0;text-align: center; width: 110px;" />
												</span>
						...
						<div class="control_group">
							...
							<div class="controls">
								<div class="input_prepend input_append">
									<div class="checker">
										<span>
											<input type="checkbox" value="1" name="searchType" id="searchType" checked="checked"/>
										</span>
									</div>
						...
						<div class="control_group">
							...
							<div class="controls">
								<textarea cols="85" rows="10" name="keyWd" id="keyWd" style="width:320px;"></textarea>
								<div class="controls_tips">
									<label class="time_label">匹配关系:</label>
									<input type="radio" name="keyWdMatchType"  checked="checked" value="1"/><label class="label_02">精准</label>
									<input type="radio" name="keyWdMatchType"   value="2"/><label class="label_02">中心</label>
								</div>
								
								<div class="controls_tips"><input type="text" name="keyWdSearchDate" id="keyWdSearchDate" class="input_time"/>
								<label class="time_label">小时内</label><label class="label_02">匹配</label>
								<input type="text" name="keyWdSearchNum" id="keyWdSearchNum" class="input_time" /><label class="label_02">次数</label></div>
							</div>
						</div>
						...
						<div class="control_group">
							...
							<div class="controls">
								<textarea cols="85" rows="10" id="urlContent" name="urlContent"  style="width:320px;"></textarea>
								<div class="controls_tips">
									<label class="time_label">匹配关系:</label>
									<input type="radio" name="urlMatchType"  checked="checked" value="1"/><label class="label_02">精准</label>
									<input type="radio" name="urlMatchType"   value="2"/><label class="label_02">中心</label>
								</div>
								<div class="controls_tips">
								<input type="text" name="urlMatchDate" id="urlMatchDate" class="input_time"/>
								<label class="time_label">小时内</label><label class="label_02">匹配</label>
								<input type="text" name="urlMatchNum" id="urlMatchNum" class="input_time" /><label class="label_02">次数</label></div>
							</div>
						</div>
					</div>
			...
			<div class="controls_data">
				...
				<div class="controls_content" id="show_person" style="display:none;">
									...
									<table cellspacing="0" cellpadding="0" width="100%" border="0">
										<tr>
											<td align="left">
												...
												<span style="position:absolute;border-top:1pt solid #c1c1c1;border-left:1pt solid #c1c1c1;border-bottom:1pt solid #c1c1c1;width:110px;height:24px;"  >
													<input type="text"  id="modelFetchCicleInput"  value="1天" style=" border: 0 none;height: 21px;line-height: 21px;margin: 0; padding: 0;text-align: center; width: 110px;" />
												</span>
					...
					<tr>
						...
						<input type="checkbox" name="modelType" value="1" style="opacity: 0;" checked="checked"/></td>
					...
					<tr>
						<td style="padding-bottom: 7px"><input type="checkbox" name="modelType" value="2" style="opacity: 0;" /></td>
					...
					<tr>
						<td style="padding-bottom: 7px"><input type="checkbox" name="modelType" value="3" style="opacity: 0;" /></td>
					...
					<div class="controls_model" style="margin-left:40px;">
						...
						<div class="models">
							<textarea cols="85" rows="10" name="modelMatchUrl" id="modelMatchUrl"  style="width:320px;"></textarea>
						</div>
					</div>
				</div>
			</div>
			<!--智能模型人群定向结束-->
			<!--兴趣标签定向开始-->
			<div class="controls_data" style="" id="interestlabelDiv">
				<div class="controls_icon">
				...
				<div class="controls_content" id="show_habbit" style="display:none;">
									...
									<table cellspacing="0" cellpadding="0" width="100%" border="0">
										<tr>
											<td align="left">
												...
												<span style="position:absolute;border-top:1pt solid #c1c1c1;border-left:1pt solid #c1c1c1;border-bottom:1pt solid #c1c1c1;width:110px;height:24px;"  >
													<input type="text"  id="interestlabelCircleInput"  value="1天" style=" border: 0 none;height: 21px;line-height: 21px;margin: 0; padding: 0;text-align: center; width: 110px;" />
												</span>
					...
					<div class="controls_model" >
						<div class="controls_box">
							...
							<div class="select_Data_DIV" id="interest_div"  style="display: none;float:right;">
							</div>
			...
			<div class="controls_data">
				...
				<div class="sex_DIV" id="sex_DIV" style="display:none;">
					<span class="habbit_type">
						...
						<input type="checkbox" name="sex" class="sex_singel"  value="2"  <c:if test="${crowdPortrait.sex=='2'}"> checked="checked"</c:if>/><label class="habbit_label">男</label>
						<input type="checkbox" name="sex" class="sex_singel"  value="3" <c:if test="${crowdPortrait.sex=='3'}"> checked="checked"</c:if>/><label class="habbit_label">女</label>
					</span>
					<span class="habbit_type">
						<label class="sex_label">年龄段：</label>
						<input type="checkbox" name="age_range" value="1"/><label class="habbit_label">10~20岁</label>
						<input type="checkbox" name="age_range" value="2"/><label class="habbit_label">21~30岁</label>
						<input type="checkbox" name="age_range" value="3"/><label class="habbit_label">31~40岁</label>
						<input type="checkbox" name="age_range" value="4"/><label class="habbit_label">大于40岁</label>
					</span>
				</div>
			</div>
			<!--人群画像定向结束-->
					...
					<div class="sex_DIV">
										...
										<tr>
											<td align="left">
												...
												<span style="position:absolute;border-top:1pt solid #c1c1c1;border-left:1pt solid #c1c1c1;border-bottom:1pt solid #c1c1c1;width:110px;height:24px;" name="lbsFetchCicle" id="lbsFetchCicle">
													<input type="text" id="lbsFetchCicleInput" value="1天" style=" border: 0 none;height: 21px;line-height: 21px;margin: 0; padding: 0;text-align: center; width: 110px;" />
												</span>
						...
						<tr>
							<td>
								...
								<input type="text" name="centryAddr1" class="lbs_input" style="width:100px;" id="centryAddr1"  onblur="checkAddress(this)"/>
							</td>
							<td>
								<label class="LBS_label">半径长度：</label>
								<input type="text" name="distanceValue1" class="lbs_input"  style="width:100px;"  id="distanceValue1"/>
	  ...
	  function add() {
		   ...
		   // 人群名称
		    ...
		    if(labelsArray.length>0){
		    	  if($.trim(interestlabelCircle)==''){
				    	showError("expressDate");
		            	moveHtml("interestlabelDiv");
		            	return;
				    }
		    }
		  ...
		  // 启用当前页面
			...
			$.ajax({
				...
				data:{crowdName:crowdName,expressDate:expressDate,isJisoujitou:isJisoujitou,
					...
					interestlabelCircle:interestlabelCircle, interestLabels:labelsArray.join(","),sex:sex,age_ranges:age_rangeArray.join(","),direct_type:direct_type,keyWdMatchType:keyWdMatchType,urlMatchType:urlMatchType},
				async:true,
				type:'POST',
				dataType:'json',
