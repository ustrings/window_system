							...
							<form class="form-horizontal" method="post"> 
								<fieldset>
									...
									<div class="control-group">
										<label class="control-label" for="focusedInput"><b style="color: #FF0000;">*</b>受众人群名称</label> <input
											type="hidden" value="${crowd.crowdId }" />
										<div class="controls">
											<input class="input-xlarge focused" id="crowdName"
												name="crowdName" type="text" value="${crowd.crowdName }" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea class="autogrow" id="crowdDesc" name="crowdDesc">${crowd.crowdDesc }</textarea>
										</div>
									</div>
								</fieldset>
								...
								<fieldset>
									...
									<legend id="KWPos">
										搜索关键词设置 <input type="checkbox" id="searchKwSwitch"
											name="searchKwSwitch" value="S" <c:if test="${crowdRule.kwSwitch == 'Y'}">checked</c:if> ></input>
									</legend>
									...
									<table>
										...
										<tr>
											...
											<td><textarea
													style="resize: none; width: 500px; height: 240px;"
										...
										<tr>
											...
											<td colspan="3"><b style="color: #FF0000;">*</b>匹配<input type="text" name="searchKwNum"
												style="width: 15px" id="searchKwNum"
												value="${crowdRule.kwNum}" /> 个关键词,介于 现在 和<input
												type="text" name="searchKwTimeNum" style="width: 15px"
												id="searchKwTimeNum" value="${crowdRule.kwTimeNum }" /><select
								...
								<fieldset>
									...
									<legend id="URLPos">
										...
										URL设置 <input type="checkbox" id="urlSwitch" name="urlSwitch"
											value="U" <c:if test="${crowdRule.urlSwitch == 'Y'}">checked</c:if> ></input>
									</legend>
									...
									<table>
										...
										<tr>
											...
											<td colspan="3"><b style="color: #FF0000;">*</b>匹配<input type="text" name="urlNum"
												...
												个url,介 现在 和<input type="text" name="urlTimeNum"
												style="width: 15px" id="urlTimeNum"
												value="${crowdRule.urlTimeNum }" /><select id="urlTimeType"
...
<script>
	$(document).on("click","#crowdEditSave",function() {
							...
							$(".form-horizontal")
									.attr("action",
											"/crowd/crowdeditsaveaction/${crowd.crowdId}");
