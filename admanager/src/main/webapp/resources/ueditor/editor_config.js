...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //,toolbars:[["fullscreen","source","undo","redo","insertunorderedlist","insertorderedlist","unlink","link","cleardoc","selectall","print","searchreplace","preview","help","separate","pagebreak","insertimage","emotion","insertvideo","attachment","date","time","horizontal","anchor","spechars","blockquote","template","background","bold","italic","strikethrough","underline","forecolor","backcolor","superscript","subscript","justifyleft","justifycenter","justifyright","justifyjustify","touppercase","tolowercase","directionalityltr","directionalityrtl","indent","removeformat","formatmatch","autotypeset","pasteplain","customstyle","paragraph","rowspacingbottom","rowspacingtop","lineheight","fontfamily","fontsize","imagenone","imageleft","imageright","imagecenter","inserttable","mergeright","deletetable","mergedown","splittorows","splittocols","splittocells","mergecells","insertcol","insertrow","deletecol","deleterow","insertparagraphbeforetable"]]
        ,toolbars:[["fullscreen","fontfamily","fontsize","bold","italic","strikethrough","underline","forecolor","backcolor","justifyleft","justifycenter","justifyright","justifyjustify","indent","insertunorderedlist","insertorderedlist","lineheight","undo","redo","inserttable","deletetable","link","unlink","cleardoc","insertimage","source","imagenone","imageleft","imageright","imagecenter"]]
