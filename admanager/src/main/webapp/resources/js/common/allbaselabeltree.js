...
//			    	onClick: onClick,
 ...
 function appendLabel(node){
	 ...
	 $("#interest_div").append(
			  "<span class='data_span' style='margin-left:0px'><label id='click_show' style='display: block;float: left;width: 70%;'>" + labels + " > " + node.name + "</label>" +
